...
//Substituir useEfeect na liha 243
...
// Substituir o useEffect da linha 243 por isso:

const fetchIngredients = async () => {
  // Usuário DEMO
  if (user?.id === "demo-user-id") {
    const stored = JSON.parse(localStorage.getItem("demo-ingredients") || "[]");
...
// Atualiza o estado interno toda vez que a query mudar
useEffect(() => {
