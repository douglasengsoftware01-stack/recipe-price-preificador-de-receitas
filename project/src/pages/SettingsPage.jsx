...
//Substituir useEfeect na liha 291
            ...
            <InfoCard>
              <InfoHeader>
                ...
                <InfoContent>
                  ...
                  <p>
                    Este valor será usado para calcular o rateio das despesas
                    fixas baseado no tempo de preparo de cada receita.
                  </p>
                </InfoContent>
              </InfoHeader>
            </InfoCard>
        ...
        <HelpCard>
          <HelpHeader>
            ...
            <HelpContent>
              ...
              <p>
                As despesas fixas mensais são divididas pelo total de horas de
                funcionamento, gerando um custo por hora. Este valor é então
                multiplicado pelo tempo de preparo de cada receita para calcular
                o rateio proporcional das despesas fixas.
              </p>
              <FormulaCard>
                <p>
                  Rateio = (Despesas Fixas ÷ Horas Mensais) × (Tempo Preparo ÷
                  60)
                </p>
              </FormulaCard>
            </HelpContent>
